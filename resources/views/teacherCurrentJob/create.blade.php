        ...
        <div class="">
            <div class="w-full mt-2 shadow  shadow-xl rounded shadow bg-gray-200 text-center rounded">
                ...
                <div class="px-6 py-8 bg-white rounded">
                    <form action="{{ route('teacherCurrentJob.store', $teacherInfo->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="p-2">
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="minstry" type="text"
                                        ...
                                        value="{{ old('minstry') }}" required autocomplete="minstry" autofocus>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="job_title" type="text"
                                        ...
                                        name="job_title" value="{{ $teacherInfo->job_title }}" required
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="position" type="text"
                                        ...
                                        name="position" value="{{ $teacherInfo->position }}" required
                            ...
                            <div class="p-2">
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="jop_posistion" type="jop_posistion"
                                        ...
                                        name="jop_posistion" required value="{{ $teacherInfo->jop_posistion }}">
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="reg_date" type="date"
                                        ...
                                        name="reg_date" value="{{ $teacherInfo->reg_date }}" required>
