            ...
            <div class="">
                <div class="w-full mt-2 shadow  shadow-xl rounded shadow bg-gray-200 text-center rounded">
                    <p class="text-blue-700 text-bold p-2">
                      ثبت معلومات تحصلی  استاد
                    </p>
                    <hr>
                    <div class="px-6 py-8 bg-white rounded">
                        <form action="{{ route('teacherEducationInfo.store',$teacherInfo->id) }}" method="POST">
                            @csrf	
                                ...
                                <div class="p-2">
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="ed_place" type="text"
                                            ...
                                            value="{{ old('ed_place')  }}" required autocomplete="ed_place" autofocus>
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="ed_center_name" type="text"
                                            ...
                                            value="{{ old('ed_center_name') }}" required autocomplete="ed_center_name" autofocus>
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="eduDegree" type="text"
                                            ...
                                            value="{{ $teacherInfo->eduDegree }}" required autocomplete="eduDegree">
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="collage" type="text"
                                            ...
                                            name="collage" value="{{ $teacherInfo->collage }}" required
                                ...
                                <div class="p-2">
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="ed_faild" type="ed_faild"
                                            ...
                                            required value="{{ $teacherInfo->ed_faild }}">
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="started_date" type="date"
                                            ...
                                            name="started_date" value="{{ $teacherInfo->started_date }}" required>
