<div>
    <div class="bg-purple-100 rounded-lg lg:w-4/5 w-full mx-auto shadow-2xl">
        <header class="section-title py-2 px-3">
            <h2>لسیت کارمندانی که آثار علمی شان در سیستم به ثبت رسانیده اند.</h2>
        </header>
                    ...
                    <tbody class="bg-white">
                        @forelse ($users as $user)
                            <tr>
                                ...
                                {{-- <td
                                    class="px-6 py-4 font-semibold whitespace-no-wrap border-b border-gray-200 text-sm leading-5">
                                    {{ $user->teacherInfo!==null?$user->teacherInfo->department->name :' '}}
                                </td> --}}

                                <td
                                    class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-semibold text-gray-900">
                                    <a href="{{ route('scientificwork.show', $user->id) }}"
                                        class="bg-indigo-400 hover:bg-indigo-300 text-white rounded py-1 px-2 ">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
                            </tr>
                        ...
                        <tr>
                            <td colspan="100%">
                                <h1 class="text-indigo-700 text-lg font-semibold text-center mt-3">
                                    هیچ آثار علمی از طرفی کدام کارمند ثبت سیستم نشده تا حالا!
                                </h1>
                            </td>
                        </tr>
                        @endforelse
