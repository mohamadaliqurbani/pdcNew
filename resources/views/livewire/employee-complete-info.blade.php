<div>
    <section class=" bg-purple-100 sm:rounded-md sm:shadow-sm sm:shadow-lg">
        <h1 class="font-bold ">لیست حساب کاربری کارمند یا کارمندان برای تکمیل کردن معلومات</h1>
                            ...
                            @forelse ($users as $user)
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <a href="{{ route('employee.create', $user->id) }}"
                                            ...
                                            title="complelete"> <i class="fa fa-check"></i>
                                        </a>
                                    </td>
                                </tr>
                            @empty
