<div>
    <div class="w-full mb-5 rounded-lg sm:shadow-sm sm:shadow-lg bg-gray-200  hover:bg-sky-700 ">
        <div class="px-6 py-4">
            ...
            <div class="grid grid-cols-4 gap-28">
                ...
                <form action="{{ route('outSidePresentor.update', $outsidepresentor->id) }}" method="POST"
                    class="col-span-3" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="name" type="text"
                                ...
                                value="{{ $outsidepresentor->name }}" autofocus>
                            @error('name')
                            ...
                            <input id="lname" type="text"
                                ...
                                value="{{ $outsidepresentor->lname }}" autofocus>
                            @error('lname')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                            <label for="education"
                            ...
                            <input id="education" type="text"
                                ...
                                name="education" value="{{ $outsidepresentor->education }}" autofocus>
                            @error('education')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                            ...
                            <textarea name="info" id="info" cols="2" rows="2"
                                class="text-right form-input w-full mb-1 @error('info')  border-red-500 @enderror ">
                        ...
                        <div>
                            ...
                            <input id="email" type="email"
                                ...
                                value="{{ $outsidepresentor->email }}" autofocus>
                            @error('email')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                            ...
                            <input id="phone" type="phone"
                                ...
                                value="{{ $outsidepresentor->phone }}" autofocus>
                            ...
                            <input id="imageprofile" type="file" wire:change="$emit('imageSelected')"
                                ...
                                value="{{ $outsidepresentor->image }}" autofocus>
                            ...
                            <div class="text-right">
                                ...
                                <input id="male" type="radio"
                                    ...
                                    value="مرد" autofocus {{ $outsidepresentor->gender == 'مرد' ? 'checked' : '' }}>

                                <label for="female" class="mr-5">زن</label>

                                <input id="female" type="radio"
                                    class=" @error('gender')  border-red-500 @enderror text-right" name="gender"
                                    value="زن" autofocus {{ $outsidepresentor->gender == 'زن' ? 'checked' : '' }}>
                ...
                <div class="">
                    <img class="col-span-1 h-48 w-full  border-2 border-white rounded" alt=""
