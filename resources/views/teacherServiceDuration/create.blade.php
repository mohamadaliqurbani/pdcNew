            ...
            <div class="">
                <div class="w-full mt-2 shadow  shadow-xl rounded shadow bg-gray-200 text-center rounded">
                    ...
                    <div class="px-6 py-8 bg-white rounded">
                        <form action="{{ route('teacherServiceDuration.store',$teacherInfo->id) }}" method="POST">
                            @csrf
                            <div class="p-2">
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="durations" type="text"
                                        ...
                                        value="{{ old('durations')  }}" required autocomplete="durations" autofocus>
                                ...
                                <div class="flex flex-wrap">
                                    <label for="duration_at" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4 mt-2">
                                        {{ __('مدت خدمت در اداره موجود') }}:
                                    </label>
                                    <input id="duration_at" type="text"
                                        class="form-input w-full @error('duration_at')  border-red-500 @enderror" name="duration_at"
                                        value="{{ old('duration_at')  }}" required autocomplete="duration_at" autofocus>
