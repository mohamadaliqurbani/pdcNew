        ...
        <div class="">
            <div class="w-full mt-2 shadow  shadow-xl rounded shadow bg-gray-200 text-center rounded">
                <p class="text-blue-700 text-bold p-2">
                    ثبت مهارت در زبان های بین المللی
                </p>
                <hr>
                <div class="px-6 py-8 bg-white rounded">
                    <form action="{{ route('teacherLangSkill.store', $teacherInfo->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="p-2">
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="lang_name" type="text"
                                        ...
                                        name="lang_name" value="{{ old('lang_name') }}" required autocomplete="lang_name"
                                        autofocus>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="reading" type="text"
                                        ...
                                        value="{{ old('reading') }}" required autocomplete="reading" autofocus>
                            ...
                            <div class="p-2">
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="speaking" type="text"
                                        ...
                                        name="speaking" value="{{ $teacherInfo->speaking }}" required
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="writing" type="text"
                                        ...
                                        value="{{ $teacherInfo->writing }}" required autocomplete="writing" autofocus>
