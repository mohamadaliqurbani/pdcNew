            ...
            <div class="">
                <div class="w-full mt-2 shadow  shadow-xl rounded shadow bg-gray-200 text-center rounded">
                    ...
                    <div class="px-6 py-8 bg-white rounded">
                        <form action="{{ route('teacherReward.store',$teacherInfo->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="p-2">
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="from_dep" type="text"
                                        ...
                                        value="{{ old('from_dep')  }}" required autocomplete="from_dep" autofocus>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="reward_type" type="text"
                                        ...
                                        value="{{ old('reward_type')  }}" required autocomplete="reward_type" autofocus>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <input id="issue_date" type="date"
                                        ...
                                        name="issue_date" value="{{ $teacherInfo->issue_date }}" required>
