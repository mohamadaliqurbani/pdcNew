                                ...
                                <div class="p-2">
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="fname" type="text"
                                            ...
                                            value="{{ $teacherInfo->fname }}" required autocomplete="fname" autofocus>
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="phone" type="text"
                                            ...
                                            value="{{ $teacherInfo->phone }}" required autocomplete="phone" autofocus>
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="dob" type="date"
                                            ...
                                            value="{{ $teacherInfo->dob }}" required autocomplete="dob">
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="birthPlace" type="text"
                                            ...
                                            name="birthPlace" value="{{ $teacherInfo->birthPlace }}" required
                                ...
                                <div class="p-2">
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="Nid" type="Nid"
                                            ...
                                            required value="{{ $teacherInfo->Nid }}">
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <input id="accpet_date" type="date"
                                            ...
                                            name="accpet_date" value="{{ $teacherInfo->accpet_date }}" required>
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <select name="department_id" id="department_id"
                                            ...
                                            <option value="0">دیپارتمنت را انتخاب نماید</option>
                                            @foreach ($departments as $department)
                                                <option {{$teacherInfo->departmentOfTeacher!=null?$teacherInfo->departmentOfTeacher->department->id== $department->id?'selected':'' :''}} value="{{ $department->id }}">{{ $department->name }}</option>
                                            @endforeach
                                        </select>
