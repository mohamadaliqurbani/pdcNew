...
@section('content')
    <div class="w-full  mr-1 px-28  ">
        <div class="bg-purple-100 rounded-lg">
            ...
            <h2 class="mx-4 pt-2 font-semibold"> ایجاد حساب کاربری برای{{ request()->is('register')?' استاد ':' کارمند ' }}</h2>
            <form class="bg-white px-5  rounded shadow-lg w-full 5 space-y-6  sm:space-y-8" enctype="multipart/form-data"
                ...
                @elseif(request()->is('register/admin'))
                    <input type="hidden" name="role" value="admin">
    
                @elseif(request()->is('register/employee'))
